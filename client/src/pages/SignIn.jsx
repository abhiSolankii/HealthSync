...
const SignIn = () => {
  ...
  return (
    <div className=" bg-slate-200 items-center w-full lg:pt-10">
      <div className="bg-white w-full lg:h-[35rem] lg:w-[60rem] mx-auto lg:flex justify-center rounded-md">
        ...
        <div className="hidden w-[50%] bg-purple-200 h-full items-center lg:flex flex-col justify-center ">
          ...
          <div className="mt-4 space-y-2 text-center lg:pl-16 lg:pr-16">
            <p className="text-lg font-medium text-gray-800">
              Log in to your account and continue tracking your health journey.
            </p>
            <p className="text-lg text-gray-600">
              Stay on top of your wellness with real-time insights and
